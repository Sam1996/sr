		...
		<div class="navbar-collapse zozo-topnavbar-collapse collapse">
			...
			<ul class="nav navbar-nav navbar-right zozo-top-right">
				...
				<li class="header-details-box">
					<div class="header-details-icon"><i class="fa fa-map-marker"></i></div>
					<div class="header-details-info header-address"><?php echo force_balance_tags( $zozo_options['zozo_header_address'] ); ?></div>
				</li>
				<?php } ?>
				...
				<li class="header-details-box">
					...
					<div class="header-details-info header-business-hours"><?php echo force_balance_tags( $zozo_options['zozo_header_business_hours'] ); ?></div>
				</li>
				<?php } ?>
				...
				<li class="header-details-box">
					...
					<div class="header-details-info header-contact-details">
						<strong><?php echo force_balance_tags( $zozo_options['zozo_header_phone'] ); ?></strong>
