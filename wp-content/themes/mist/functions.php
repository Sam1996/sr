...
define( 'ZOZO_ADMIN_ASSETS', get_template_directory_uri() . '/admin/assets/' );
define( 'ZOZO_ADMIN_ASSETS_DIR', get_template_directory() . '/admin/assets/' );
 ...
 */
require ZOZOADMIN . 'theme-options.php';
...
include_once( ZOZOTHEME_DIR . '/widgets/twitter-widget/tweets_widget.php');
