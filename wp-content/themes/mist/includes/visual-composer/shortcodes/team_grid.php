					...
					$output .= '<div class="team-item '.$column_class.' text-'.$text_align.'">';
						...
						$output .= '<div class="team-content">';
							...
							if( isset( $show_socials ) && $show_socials == 'yes' ) {
								if( ( isset( $facebook ) && $facebook != '' ) || ( isset( $twitter ) && $twitter != '' ) || ( isset( $googleplus ) && $googleplus != '' ) || ( isset( $linkedin ) && $linkedin != '' ) || ( isset( $pinterest ) && $pinterest != '' ) || ( isset( $dribbble ) && $dribbble != '' ) || ( isset( $skype ) && $skype != '' ) || ( isset( $yahoo ) && $yahoo != '' ) || ( isset( $youtube ) && $youtube != '' ) ) { 
								$output .= '<div class="zozo-team-social">';
									$output .= '<ul class="zozo-social-icons soc-icon-transparent zozo-team-social-list">';
										...
										if( isset( $googleplus ) && $googleplus != '' ) {
											$output .= '<li class="googleplus"><a target="'.esc_attr( $link_target ).'" href="'.esc_url( $googleplus ).'"><i class="fa fa-google-plus"></i></a></li>' . "\n";
										}
