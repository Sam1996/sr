...
Modified Version of WordPress Importer - Added menu import for custom fields
*/
...
<?php
	...
	function process_menu_item( $item ) {
		...
		$id = zozo_wp_update_nav_menu_item( $menu_id, 0, $args );
...
if ( !function_exists( 'zozo_wp_update_nav_menu_item' ) ) {
	
	function zozo_wp_update_nav_menu_item( $menu_id = 0, $menu_item_db_id = 0, $menu_item_data = array() ) {
		...
		if ( ! empty( $menu_item_db_id ) && ! is_nav_menu_item( $menu_item_db_id ) )
			return new WP_Error('update_nav_menu_item_failed', __('The given object ID is not that of a menu item.', 'wordpress-importer'));
		...
		// Custom Fields
		update_post_meta( $menu_item_db_id, '_menu_item_zozo_megamenu_menutype', $args['menu_item_zozo_megamenu_menutype'] );
		update_post_meta( $menu_item_db_id, '_menu_item_zozo_megamenu_status', $args['menu_item_zozo_megamenu_status'] );
		update_post_meta( $menu_item_db_id, '_menu_item_zozo_megamenu_columns', $args['menu_item_zozo_megamenu_columns'] );
		update_post_meta( $menu_item_db_id, '_menu_item_zozo_megamenu_title', $args['menu_item_zozo_megamenu_title'] );
		update_post_meta( $menu_item_db_id, '_menu_item_zozo_megamenu_link', $args['menu_item_zozo_megamenu_link'] );
		update_post_meta( $menu_item_db_id, '_menu_item_zozo_megamenu_content', $args['menu_item_zozo_megamenu_content'] );
		update_post_meta( $menu_item_db_id, '_menu_item_zozo_megamenu_icon', $args['menu_item_zozo_megamenu_icon'] );
		...
		do_action('zozo_wp_update_nav_menu_item', $menu_id, $menu_item_db_id, $args );
