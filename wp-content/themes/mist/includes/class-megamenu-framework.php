...
if( ! class_exists( 'Zozo_Mega_Menu_Core' ) ) {
    ...
    class Zozo_Mega_Menu_Core {
		...
		function zozo_menu_enqueue_scripts() {
			...
			// scripts
			//wp_enqueue_media();
			wp_register_script( 'zozo-megamenu', get_template_directory_uri() . '/admin/assets/js/zozo-megamenu.js', array( 'jquery' ), false, true );
			wp_enqueue_script( 'zozo-megamenu' );
			
			wp_register_style( 'zozo_megamenu_admin', get_template_directory_uri() . '/admin/assets/css/zozo-megamenu.css' );
